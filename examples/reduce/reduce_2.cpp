...
{
  {
    ...
    int result = reduce(par.on(pool.executor()), vec.begin(), vec.end(), 13, std::plus<>());
...

  {
    ...
    int result = reduce(par.on(pool.executor()), lst.begin(), lst.end(), 13, std::plus<>());
  ...
  //  reduce(par.on(pool.executor()), vec.begin(), vec.end(), 13, [](int x, int y)
  //  {
  //    throw 13;
  ...
  //  reduce(par.on(pool.executor()), lst.begin(), lst.end(), 13, [](int x, int y)
  //  {
  //    throw 13;
  ...
  //  reduce(par.on(pool.executor()), make_throwing_iterator(vec.begin()), make_throwing_iterator(vec.end()), 13, std::plus<>());
  ...
  //  reduce(par.on(pool.executor()), make_throwing_iterator(lst.begin()), make_throwing_iterator(lst.end()), 13, std::plus<>());
