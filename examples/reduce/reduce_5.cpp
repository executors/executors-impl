...
{
  {
    ...
    int result = reduce(par.on(throwing_executor()), vec.begin(), vec.end(), 13, std::plus<>());
...

  {
    ...
    int result = reduce(par.on(throwing_executor()), lst.begin(), lst.end(), 13, std::plus<>());
  ...
  //  try
  //  {
  //    reduce(par.on(throwing_executor()), vec.begin(), vec.end(), 13, [](int x, int y)
  //    {
  //      throw 13;
  ...
  //  try
  //  {
  //    reduce(par.on(throwing_executor()), lst.begin(), lst.end(), 13, [](int x, int y)
  //    {
  //      throw 13;
  ...
  //  try
  //  {
  //    reduce(par.on(throwing_executor()), make_throwing_iterator(vec.begin()), make_throwing_iterator(vec.end()), 13, std::plus<>());
  //  }
  //  catch(...) {}
  ...
  //  try
  //  {
  //    reduce(par.on(throwing_executor()), make_throwing_iterator(lst.begin()), make_throwing_iterator(lst.end()), 13, std::plus<>());
  //  }
  //  catch(...) {}
