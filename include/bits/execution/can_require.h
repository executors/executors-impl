#ifndef STD_BITS_EXECUTION_CAN_REQUIRE_H_INCLUDED
#define STD_BITS_EXECUTION_CAN_REQUIRE_H_INCLUDED
...
struct eval<Executor, std::tuple<Properties...>,
  std::void_t<decltype(
    ::std::execution::require(std::declval<Executor>(), std::declval<Properties>()...)
  )>> : std::true_type {};
...
#endif // STD_BITS_EXECUTION_CAN_REQUIRE_H_INCLUDED
