#ifndef STD_BITS_EXECUTION_QUERY_FREE_TRAITS_H_INCLUDED
#define STD_BITS_EXECUTION_QUERY_FREE_TRAITS_H_INCLUDED
...
#endif // STD_BITS_EXECUTION_QUERY_FREE_TRAITS_H_INCLUDED
