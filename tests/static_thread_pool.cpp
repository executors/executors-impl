...
void static_thread_pool_twoway_executor_compile_test(Executor ex1)
{
  ...
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::blocking.never));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::blocking.possibly));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::blocking.always));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::relationship.fork));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::relationship.continuation));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::outstanding_work.untracked));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::outstanding_work.tracked));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::bulk_guarantee.parallel));
  static_thread_pool_twoway_executor_compile_test(execution::require(cex1, execution::mapping.thread));
  ...
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::blocking.never));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::blocking.possibly));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::blocking.always));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::relationship.fork));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::relationship.continuation));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::outstanding_work.untracked));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::outstanding_work.tracked));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::bulk_guarantee.sequenced));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::bulk_guarantee.parallel));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::bulk_guarantee.unsequenced));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::mapping.thread));
  static_thread_pool_twoway_executor_compile_test(execution::prefer(cex1, execution::mapping.new_thread));
...
void static_thread_pool_bulk_twoway_executor_compile_test(Executor ex1)
{
  ...
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::blocking.never));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::blocking.possibly));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::blocking.always));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::relationship.fork));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::relationship.continuation));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::outstanding_work.untracked));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::outstanding_work.tracked));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::bulk_guarantee.parallel));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::require(cex1, execution::mapping.thread));
  ...
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::blocking.never));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::blocking.possibly));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::blocking.always));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::relationship.fork));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::relationship.continuation));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::outstanding_work.untracked));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::outstanding_work.tracked));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::bulk_guarantee.sequenced));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::bulk_guarantee.parallel));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::bulk_guarantee.unsequenced));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::mapping.thread));
  static_thread_pool_bulk_twoway_executor_compile_test(execution::prefer(cex1, execution::mapping.new_thread));
